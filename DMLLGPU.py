...
class Dropout:
    def __init__(
        ...
        """
        node_number: Number of node in the neural network. Every node number must be assigned before neural network is finalised.
        dropout_probability: Probability of node being dropped out. If set to 0.0 or a negative number, then the node will assume a value of 1.0 with the probability of the corresponding input node or 0.0 otherwise.
