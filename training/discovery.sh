...
nvcc -std=c++11 -ccbin g++ -m64 -gencode arch=$COMPUTE_CAPABILITY,code=$COMPUTE_CAPABILITY -c DiscoveryCpp_wrap.cu -lcublas -lcusparse -I/usr/include/python2.7 -I$NUMPY_PATH -Xcompiler -fPIC 
