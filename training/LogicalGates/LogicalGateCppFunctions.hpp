LogicalGateCpp::LogicalGateCpp(
    ...
    std::int32_t _hidden_nodes_fed_into_me_length) : NeuralNetworkNodeCpp(_node_number,
									  _dim,
									  nullptr,
									  0,
									  nullptr,
    ...
    const std::int32_t _batch_size)
{
	...
	thrust::for_each(
	    ...
	    thrust::make_zip_iterator(
		thrust::make_tuple(
		    this->hidden_nodes_fed_into_me_ptr_[0]->get_output().begin() + this->dim_ * _batch_size,
		    this->hidden_nodes_fed_into_me_ptr_[1]->get_output().begin() + this->dim_ * _batch_size,
	...
	thrust::for_each(
		...
		thrust::make_tuple(
		    this->hidden_nodes_fed_into_me_ptr_[0]->get_output().begin() + this->dim_ * _batch_size,
		    this->hidden_nodes_fed_into_me_ptr_[1]->get_output().begin() + this->dim_ * _batch_size,
		    this->hidden_nodes_fed_into_me_ptr_[2]->get_output().begin() + this->dim_ * _batch_size,
		    this->output_.begin() + this->dim_ * _batch_size)),
	...
	thrust::for_each(
		...
		thrust::make_tuple(
		    ...
		    this->hidden_nodes_fed_into_me_ptr_[1]->get_output().begin() + this->dim_ * _batch_size,
		    this->hidden_nodes_fed_into_me_ptr_[2]->get_output().begin() + this->dim_ * _batch_size,
		    this->hidden_nodes_fed_into_me_ptr_[3]->get_output().begin() + this->dim_ * _batch_size,
		    this->output_.begin() + this->dim_ * _batch_size)),
...
void LogicalGateCpp::calc_delta(std::int32_t _batch_size)
{
	...
	thrust::for_each(
	    ...
	    thrust::make_zip_iterator(
		thrust::make_tuple(
		    this->delta_.begin() + this->dim_ * _batch_size,
		    this->hidden_nodes_fed_into_me_ptr_[0]->get_output().begin() + this->dim_ * _batch_size,
		    this->hidden_nodes_fed_into_me_ptr_[1]->get_output().begin() + this->dim_ * _batch_size,
		    this->hidden_nodes_fed_into_me_ptr_[0]->get_delta().begin() + this->dim_ * _batch_size,
		    this->hidden_nodes_fed_into_me_ptr_[1]->get_delta().begin() + this->dim_ * _batch_size)),
	...
	thrust::for_each(
		...
		thrust::make_tuple(
		    ...
		    this->hidden_nodes_fed_into_me_ptr_[0]->get_delta().begin() + this->dim_ * _batch_size,
		    this->hidden_nodes_fed_into_me_ptr_[1]->get_delta().begin() + this->dim_ * _batch_size,
		    this->hidden_nodes_fed_into_me_ptr_[2]->get_delta().begin() + this->dim_ * _batch_size)),
	...
	thrust::for_each(
		...
		thrust::make_tuple(
		    ...
		    this->hidden_nodes_fed_into_me_ptr_[1]->get_delta().begin() + this->dim_ * _batch_size,
		    this->hidden_nodes_fed_into_me_ptr_[2]->get_delta().begin() + this->dim_ * _batch_size,
		    this->hidden_nodes_fed_into_me_ptr_[3]->get_delta().begin() + this->dim_ * _batch_size)),
