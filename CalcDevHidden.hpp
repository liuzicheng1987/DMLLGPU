...
void calc_dev_hidden(float *dLdw, NeuralNetworkNodeGPUCpp **HiddenNodesFedIntoMePtr, std::size_t HiddenNodesFedIntoMePtrSize, thrust::device_vector<float> &delta) {
  ...
  case 1:
    ...
    res1 = thrust::transform_reduce(thrust::device, thrust::make_zip_iterator(thrust::make_tuple(delta.begin(), HiddenNodesFedIntoMePtr[0]->get_output().begin())),
                                                    thrust::make_zip_iterator(thrust::make_tuple(delta.end(), HiddenNodesFedIntoMePtr[0]->get_output().end())),
  ...
  case 2:
    ...
    res2 = thrust::transform_reduce(thrust::device, thrust::make_zip_iterator(thrust::make_tuple(delta.begin(), HiddenNodesFedIntoMePtr[0]->get_output().begin(), HiddenNodesFedIntoMePtr[1]->get_output().begin())),
                                                    thrust::make_zip_iterator(thrust::make_tuple(delta.end(), HiddenNodesFedIntoMePtr[0]->get_output().end(), HiddenNodesFedIntoMePtr[1]->get_output().end())),
  ...
  case 3:
    ...
    res3 = thrust::transform_reduce(thrust::device, thrust::make_zip_iterator(thrust::make_tuple(delta.begin(), HiddenNodesFedIntoMePtr[0]->get_output().begin(), HiddenNodesFedIntoMePtr[1]->get_output().begin(), HiddenNodesFedIntoMePtr[2]->get_output().begin())),
                                                    thrust::make_zip_iterator(thrust::make_tuple(delta.end(), HiddenNodesFedIntoMePtr[0]->get_output().end(), HiddenNodesFedIntoMePtr[1]->get_output().end(), HiddenNodesFedIntoMePtr[2]->get_output().end())),
  ...
  case 4:
    ...
    res4 = thrust::transform_reduce(thrust::device, thrust::make_zip_iterator(thrust::make_tuple(delta.begin(), HiddenNodesFedIntoMePtr[0]->get_output().begin(), HiddenNodesFedIntoMePtr[1]->get_output().begin(), HiddenNodesFedIntoMePtr[2]->get_output().begin(), HiddenNodesFedIntoMePtr[3]->get_output().begin())),
                                                    thrust::make_zip_iterator(thrust::make_tuple(delta.end(), HiddenNodesFedIntoMePtr[0]->get_output().end(), HiddenNodesFedIntoMePtr[1]->get_output().end(), HiddenNodesFedIntoMePtr[2]->get_output().end(), HiddenNodesFedIntoMePtr[3]->get_output().end())),
  ...
  case 5:
    ...
    res5 = thrust::transform_reduce(thrust::device, thrust::make_zip_iterator(thrust::make_tuple(delta.begin(), HiddenNodesFedIntoMePtr[0]->get_output().begin(), HiddenNodesFedIntoMePtr[1]->get_output().begin(), HiddenNodesFedIntoMePtr[2]->get_output().begin(), HiddenNodesFedIntoMePtr[3]->get_output().begin(), HiddenNodesFedIntoMePtr[4]->get_output().begin())),
                                                    thrust::make_zip_iterator(thrust::make_tuple(delta.end(), HiddenNodesFedIntoMePtr[0]->get_output().end(), HiddenNodesFedIntoMePtr[1]->get_output().end(), HiddenNodesFedIntoMePtr[2]->get_output().end(), HiddenNodesFedIntoMePtr[3]->get_output().end(), HiddenNodesFedIntoMePtr[4]->get_output().end())),
  ...
  case 6:
    ...
    res6 = thrust::transform_reduce(thrust::device, thrust::make_zip_iterator(thrust::make_tuple(delta.begin(), HiddenNodesFedIntoMePtr[0]->get_output().begin(), HiddenNodesFedIntoMePtr[1]->get_output().begin(), HiddenNodesFedIntoMePtr[2]->get_output().begin(), HiddenNodesFedIntoMePtr[3]->get_output().begin(), HiddenNodesFedIntoMePtr[4]->get_output().begin(), HiddenNodesFedIntoMePtr[5]->get_output().begin())),
                                                    thrust::make_zip_iterator(thrust::make_tuple(delta.end(), HiddenNodesFedIntoMePtr[0]->get_output().end(), HiddenNodesFedIntoMePtr[1]->get_output().end(), HiddenNodesFedIntoMePtr[2]->get_output().end(), HiddenNodesFedIntoMePtr[3]->get_output().end(), HiddenNodesFedIntoMePtr[4]->get_output().end(), HiddenNodesFedIntoMePtr[5]->get_output().end())),
  ...
  case 7:
    ...
    res7 = thrust::transform_reduce(thrust::device, thrust::make_zip_iterator(thrust::make_tuple(delta.begin(), HiddenNodesFedIntoMePtr[0]->get_output().begin(), HiddenNodesFedIntoMePtr[1]->get_output().begin(), HiddenNodesFedIntoMePtr[2]->get_output().begin(), HiddenNodesFedIntoMePtr[3]->get_output().begin(), HiddenNodesFedIntoMePtr[4]->get_output().begin(), HiddenNodesFedIntoMePtr[5]->get_output().begin(), HiddenNodesFedIntoMePtr[6]->get_output().begin())),
                                                    thrust::make_zip_iterator(thrust::make_tuple(delta.end(), HiddenNodesFedIntoMePtr[0]->get_output().end(), HiddenNodesFedIntoMePtr[1]->get_output().end(), HiddenNodesFedIntoMePtr[2]->get_output().end(), HiddenNodesFedIntoMePtr[3]->get_output().end(), HiddenNodesFedIntoMePtr[4]->get_output().end(), HiddenNodesFedIntoMePtr[5]->get_output().end(), HiddenNodesFedIntoMePtr[6]->get_output().end())),
  ...
  case 8:
    ...
    res8 = thrust::transform_reduce(thrust::device, thrust::make_zip_iterator(thrust::make_tuple(delta.begin(), HiddenNodesFedIntoMePtr[0]->get_output().begin(), HiddenNodesFedIntoMePtr[1]->get_output().begin(), HiddenNodesFedIntoMePtr[2]->get_output().begin(), HiddenNodesFedIntoMePtr[3]->get_output().begin(), HiddenNodesFedIntoMePtr[4]->get_output().begin(), HiddenNodesFedIntoMePtr[5]->get_output().begin(), HiddenNodesFedIntoMePtr[6]->get_output().begin(), HiddenNodesFedIntoMePtr[7]->get_output().begin())),
                                                    thrust::make_zip_iterator(thrust::make_tuple(delta.end(), HiddenNodesFedIntoMePtr[0]->get_output().end(), HiddenNodesFedIntoMePtr[1]->get_output().end(), HiddenNodesFedIntoMePtr[2]->get_output().end(), HiddenNodesFedIntoMePtr[3]->get_output().end(), HiddenNodesFedIntoMePtr[4]->get_output().end(), HiddenNodesFedIntoMePtr[5]->get_output().end(), HiddenNodesFedIntoMePtr[6]->get_output().end(), HiddenNodesFedIntoMePtr[7]->get_output().end())),
  ...
  case 9:
    ...
    res9 = thrust::transform_reduce(thrust::device, thrust::make_zip_iterator(thrust::make_tuple(delta.begin(), HiddenNodesFedIntoMePtr[0]->get_output().begin(), HiddenNodesFedIntoMePtr[1]->get_output().begin(), HiddenNodesFedIntoMePtr[2]->get_output().begin(), HiddenNodesFedIntoMePtr[3]->get_output().begin(), HiddenNodesFedIntoMePtr[4]->get_output().begin(), HiddenNodesFedIntoMePtr[5]->get_output().begin(), HiddenNodesFedIntoMePtr[6]->get_output().begin(), HiddenNodesFedIntoMePtr[7]->get_output().begin(), HiddenNodesFedIntoMePtr[8]->get_output().begin())),
                                                    thrust::make_zip_iterator(thrust::make_tuple(delta.end(), HiddenNodesFedIntoMePtr[0]->get_output().end(), HiddenNodesFedIntoMePtr[1]->get_output().end(), HiddenNodesFedIntoMePtr[2]->get_output().end(), HiddenNodesFedIntoMePtr[3]->get_output().end(), HiddenNodesFedIntoMePtr[4]->get_output().end(), HiddenNodesFedIntoMePtr[5]->get_output().end(), HiddenNodesFedIntoMePtr[6]->get_output().end(), HiddenNodesFedIntoMePtr[7]->get_output().end(), HiddenNodesFedIntoMePtr[8]->get_output().end())),
